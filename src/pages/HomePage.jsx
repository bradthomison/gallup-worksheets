...
const NAV_ITEMS = [
  ...
  },
  {
    title: 'Themes',
    href: '/themes',
    description: 'Build and manage session prompt themes. Each theme is a set of questions participants reflect on during a group workshop.',
    icon: (
      <svg className="w-6 h-6" fill="none" stroke="currentColor" viewBox="0 0 24 24">
  ...
  },
  {
    title: 'Reports',
    href: '/reports',
    description: 'Create and manage strength-based reports. Personal Insights and custom reports can be shared with participants via a direct link.',
    icon: (
      <svg className="w-6 h-6" fill="none" stroke="currentColor" viewBox="0 0 24 24">
